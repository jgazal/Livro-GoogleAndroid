...
import br.com.livroandroid.cap32.hellocontatos.exemplo1.ListaContatosActivity;
        ...
        try {
            switch (position) {
                case 0:
                    ...
                    break;
                case 1:
                    startActivity(new Intent(getBaseContext(), br.com.livroandroid.cap32.hellocontatos.exemplo2.ListaContatosActivity.class));
                    break;
                case 2:
                    startActivity(new Intent(getBaseContext(), br.com.livroandroid.cap32.hellocontatos.exemplo3.ListaContatosActivity.class));
                    break;
                case 3:
                    startActivity(new Intent(getBaseContext(), br.com.livroandroid.cap32.hellocontatos.exemplo4.ListaContatosActivity.class));
                    break;
                default:
                    finish();
                    break;
