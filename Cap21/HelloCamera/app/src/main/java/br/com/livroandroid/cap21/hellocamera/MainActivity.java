package br.com.livroandroid.cap21.hellocamera;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showImage(File file) {
        if (file != null && file.exists()) {
            ...
            Toast.makeText(this, "w/h:" + imgView.getWidth() + "/" + imgView.getHeight() + " > " +
                    "w/h:" + bitmap.getWidth() + "/" + bitmap.getHeight(), Toast.LENGTH_SHORT).show();
