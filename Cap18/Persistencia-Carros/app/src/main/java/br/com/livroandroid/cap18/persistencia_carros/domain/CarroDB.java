package br.com.livroandroid.cap18.persistencia_carros.domain;
...
public class CarroDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table if not exists carro (_id integer primary key autoincrement," +
                "nome text, desc text, url_foto text,url_info text,url_video text, latitude text," +
                "longitude text, tipo text);");
