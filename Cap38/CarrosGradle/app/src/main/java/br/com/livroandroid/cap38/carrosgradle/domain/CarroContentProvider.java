package br.com.livroandroid.cap38.carrosgradle.domain;
 ...
 * <pre>
 *
 * Content Provider para armazenar Carros
 *
 * URI:
 *
 * Todos
...
public class CarroContentProvider extends ContentProvider {
    ...
    public static final class Carros implements BaseColumns {
        ...
        // A Uri é no formato "content://br.com.livroandroid.carros/carros/id"
    ...
    public boolean onCreate() {
        ...
        // content://br.com.livroandroid.carros/carros/id
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if(projection == null) {
            projection = new String[] {"_id",Carros.NOME,Carros.DESC,Carros.URL_INFO,Carros.URL_FOTO,Carros.URL_VIDEO,Carros.LATITUDE,Carros.LONGITUDE,Carros.TIPO};
        }
